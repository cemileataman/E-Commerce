...
function displayCartProduct() {
  ...
  let result = ""; // let kullanarak değişken tanımladık
  ...
  cartWrapper.innerHTML = result; // result'ı innerHTML olarak ayarla
  removeCartItem();
}

// DOMContentLoaded olayını dinleyerek fonksiyonları çağır
...
function removeCartItem() {
  ...
  btnDeleteCart.forEach((button) => {
    button.addEventListener("click", function (e) {
      const id = e.target.dataset.id; // Doğru kullanım: dataset.id
